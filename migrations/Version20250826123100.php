...
final class Version20250826123100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE time_slots (id INT AUTO_INCREMENT NOT NULL, workshop_id INT NOT NULL, date DATE NOT NULL, from_time TIME NOT NULL, to_time TIME NOT NULL, INDEX UNIQ_8D06D4AC1FDCE57C (workshop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
